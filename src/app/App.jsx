        ...
        <ErrorBoundary>
          ...
          <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.75, ease: "easeOut" }}>
            ...
            <Link
              ...
              className="fixed right-3 top-3 z-50 rounded-2xl border border-[#155dfc]/45 bg-[linear-gradient(145deg,rgba(21,93,252,0.2),rgba(40,10,10,0.45))] px-3 py-2 shadow-[0_0_24px_rgba(21,93,252,0.42),inset_0_1px_0_rgba(255,255,255,0.2)] backdrop-blur-xl transition-transform duration-200 hover:scale-105 sm:right-4 sm:top-4"
            >
              <img
                src={logoDark}
                alt="Devfraol logo"
                className="block h-6 w-auto select-none drop-shadow-[0_0_10px_rgba(21,93,252,0.75)] sm:h-7"
              />
            </Link>
