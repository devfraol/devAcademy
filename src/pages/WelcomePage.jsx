    ...
    <AnimatePresence>
      {!isExiting && (
        ...
        >
          ...
          <motion.div
            className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(0,150,137,0.23),transparent_42%),radial-gradient(circle_at_80%_10%,rgba(0,150,137,0.15),transparent_35%),radial-gradient(circle_at_50%_80%,rgba(255,255,255,0.07),transparent_45%)]"
          ...
          {particles.map((particle) => (
            <motion.span
              key={particle.id}
              className={`absolute rounded-full bg-[#009689]/65 ${particle.size}`}
          ...
          <div className="relative w-full max-w-3xl rounded-3xl border border-white/10 bg-white/5 p-7 shadow-[0_0_100px_rgba(0,150,137,0.2)] backdrop-blur-2xl sm:p-10">
            <div className="text-center">
              ...
              >
                <span className="bg-gradient-to-r from-[#009689] via-[#009689] to-[#009689] bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(0,150,137,0.32)]">
                  {typedMessage}
                </span>
                <span className="ml-1 inline-block h-7 w-[2px] translate-y-1 animate-pulse bg-[#009689]" />
              </motion.h1>
