    ...
    <AnimatePresence>
      {!isExiting && (
        ...
        >
          ...
          <motion.div
            className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(0,122,85,0.23),transparent_42%),radial-gradient(circle_at_80%_10%,rgba(0,122,85,0.15),transparent_35%),radial-gradient(circle_at_50%_80%,rgba(255,255,255,0.07),transparent_45%)]"
          ...
          {particles.map((particle) => (
            <motion.span
              key={particle.id}
              className={`absolute rounded-full bg-[#007a55]/65 ${particle.size}`}
          ...
          <div className="relative w-full max-w-3xl rounded-3xl border border-white/10 bg-white/5 p-7 shadow-[0_0_100px_rgba(0,122,85,0.2)] backdrop-blur-2xl sm:p-10">
            <motion.img
              src={logoDark}
              alt="Dev Fraol Academy"
              className="mx-auto w-52 sm:w-64 md:w-72"
              initial={{ opacity: 0, scale: 0.8, y: 20 }}
              animate={{ opacity: 1, scale: 1, y: 0, filter: "drop-shadow(0 0 20px rgba(0,122,85,0.45))" }}
            ...
            <div className="mt-7 text-center">
              ...
              >
                <span className="bg-gradient-to-r from-[#007a55] via-[#d81f1a] to-[#a91212] bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(0,122,85,0.32)]">
                  {typedMessage}
                </span>
                <span className="ml-1 inline-block h-7 w-[2px] translate-y-1 animate-pulse bg-[#007a55]" />
              </motion.h1>
