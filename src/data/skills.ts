...
export const skillCategories = [
  { id: "all", label: "All Skills", color: "bg-gradient-to-r from-emerald-600 to-emerald-600" },
  { id: "frontend", label: "Frontend", color: "bg-gradient-to-r from-emerald-600 to-teal-600" },
  { id: "backend", label: "Backend", color: "bg-gradient-to-r from-green-500 to-emerald-500" },
  { id: "tools", label: "Tools", color: "bg-gradient-to-r from-emerald-500 to-yellow-500" },
]
