export const projects = [
  ...
  },
  {
    ...
    featured: true,
    accentColor: "from-teal-500 to-teal-500",
    status: "Live",
...
export const projectCategoryColors = {
  ...
  "E-commerce": "from-teal-500/20 to-teal-500/20 text-teal-500 border-teal-500/30",
  "Real-time Communication": "from-teal-500/20 to-teal-500/20 text-teal-500 border-teal-500/30",
  "Artificial Intelligence": "from-amber-500/20 to-orange-600/20 text-amber-600 border-amber-500/30",
  "FinTech": "from-teal-500/20 to-teal-600/20 text-teal-600 border-teal-500/30",
  "Food Tech": "from-teal-500/20 to-teal-600/20 text-teal-500 border-teal-500/30",
  "HR Tech": "from-teal-500/20 to-teal-600/20 text-teal-600 border-teal-500/30"
}
