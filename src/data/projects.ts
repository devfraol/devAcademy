export const projects = [
  ...
  },
  {
    ...
    featured: true,
    accentColor: "from-blue-500 to-blue-500",
    status: "Live",
  ...
  },
  {
    ...
    accentColor: "from-blue-500 to-pink-600",
    status: "Live",
...
export const projectCategoryColors = {
  ...
  "E-commerce": "from-blue-500/20 to-orange-500/20 text-blue-500 border-blue-500/30",
  "Real-time Communication": "from-blue-500/20 to-blue-500/20 text-blue-500 border-blue-500/30",
  "Artificial Intelligence": "from-amber-500/20 to-orange-600/20 text-amber-600 border-amber-500/30",
  "FinTech": "from-blue-500/20 to-pink-600/20 text-blue-600 border-blue-500/30",
  "Food Tech": "from-blue-500/20 to-blue-600/20 text-blue-500 border-blue-500/30",
  "HR Tech": "from-orange-500/20 to-blue-600/20 text-orange-600 border-orange-500/30"
}
