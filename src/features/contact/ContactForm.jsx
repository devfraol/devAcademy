    ...
    >
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4" noValidate>
        {[
          ...
          <div key={name}>
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl border border-white/10 bg-black/30 px-3 py-2 text-white outline-none transition focus:border-[#009689] focus:ring-2 focus:ring-[#009689]/40"
            />
            {errors[name] && (
              <p id={`${name}-error`} className="mt-1 text-xs text-teal-400">
                {errors[name]}
              </p>
            )}
          </div>
        ...
        <div>
          ...
          />
          {errors.message && (
            <p id="message-error" className="mt-1 text-xs text-teal-400">
              {errors.message}
            </p>
          )}
        </div>
        ...
        <motion.button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#009689] px-4 py-3 font-semibold text-white transition hover:bg-[#009689] disabled:cursor-not-allowed disabled:opacity-70"
        >
