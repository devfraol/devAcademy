  ...
  return (
    ...
    >
      ...
      <ul className="mt-5 space-y-4">
        {contactDetails.map(({ label, value, href }) => {
          ...
          <li key={label} className="flex items-start gap-3">
            <span className="mt-0.5 rounded-lg border border-white/10 bg-black/30 p-2 text-[#009689]">
      ...
      <div className="mt-6 border-t border-white/10 pt-5">
        ...
        <SocialLinks className="gap-2" iconClassName="bg-black/30 border-white/10 text-zinc-200 hover:text-[#009689]" iconOnly />
      </div>
    </motion.article>
  );
};
