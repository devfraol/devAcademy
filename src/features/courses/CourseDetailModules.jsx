          ...
          >
            <button
              ...
              className={`flex w-full items-center justify-between gap-4 px-6 py-5 text-left transition duration-300 ${
                isOpen
                  ? "bg-gradient-to-r from-[#007a55]/25 via-[#007a55]/12 to-transparent brightness-110"
                  : "hover:bg-[#1A1A1F]"
              }`}
            ...
            >
              ...
              <ChevronDown className={`h-5 w-5 text-[#007a55] transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`} />
            </button>
                    ...
                    {module.lessons.map((lesson) => {
                      ...
                      return (
                        <li key={lesson.id} className="border-b border-[#232326] last:border-b-0">
                          ...
                          >
                            <span
                              className={`absolute left-0 top-2 h-[calc(100%-16px)] w-[3px] rounded-full bg-[#007a55] transition-opacity ${
                            ...
                            {lesson.completed ? <CheckCircle2 className="h-4 w-4 shrink-0 text-[#007a55]" aria-hidden="true" /> : null}
                          </button>
                        </li>
                      );
                    })}
