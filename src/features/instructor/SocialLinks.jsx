      ...
      {socialPlatforms.map(({ name, href, Icon }) => (
        <li key={name}>
          <motion.a
            ...
            className={`inline-flex items-center gap-2 rounded-full border border-border bg-card/70 px-4 py-2 text-sm font-medium text-muted-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#009689] focus-visible:ring-offset-2 focus-visible:ring-offset-background hover:text-[#009689] ${iconClassName}`.trim()}
          >
