...
export const InstructorHero = () => {
  return (
    <header className="relative overflow-hidden rounded-3xl border border-border/60 bg-card/55 px-6 py-14 text-left sm:px-10">
      <motion.div
        className="pointer-events-none absolute inset-0 bg-radial-[circle_at_top_right] from-[#155dfc]/30 via-transparent to-transparent"
        animate={{ opacity: [0.25, 0.45, 0.25] }}
        transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
      />

      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }} className="relative">
        <p className="inline-flex rounded-full border border-[#155dfc]/40 bg-[#155dfc]/12 px-4 py-1 text-sm font-semibold tracking-wide text-[#155dfc]">
        ...
        <div className="mt-7 h-1 w-28 rounded-full bg-[#155dfc] shadow-[0_0_20px_rgba(21,93,252,0.8)]" />
