  ...
  return (
    <main className="px-4 py-14 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-6xl">
        ...
        >
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#007a55]">Dev Fraol Academy</p>
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="mt-6">
            <Link
              to="/apps"
              className="inline-flex items-center justify-center rounded-full bg-[#007a55] px-7 py-3 text-sm font-semibold text-white shadow-[0_12px_24px_rgba(0,122,85,0.3)] transition-all duration-300 hover:bg-[#008a61] hover:shadow-[0_14px_28px_rgba(0,122,85,0.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#007a55] focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-950"
            >
