...
const TestimonialCardComponent = ({ testimonial, priority = false }) => {
  return (
    <motion.article
      ...
      className="group h-full rounded-2xl border border-gray-200 bg-white/95 p-6 shadow-sm transition-all duration-300 hover:border-[#009689]/70 hover:shadow-[0_12px_30px_rgba(0,150,137,0.16)] dark:border-gray-700 dark:bg-gray-900/70"
    >
      <header className="mb-4 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-[#009689]">{testimonial.course}</p>
        </div>
      </header>
