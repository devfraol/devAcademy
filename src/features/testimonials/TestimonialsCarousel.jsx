            ...
            {testimonials.map((item, index) => {
              ...
              return (
                <button
                  ...
                  className={`h-2.5 rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#009689] ${
                    isActive ? "w-6 bg-[#009689]" : "w-2.5 bg-gray-400/70 dark:bg-gray-500"
                  }`}
