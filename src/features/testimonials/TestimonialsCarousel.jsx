            ...
            {testimonials.map((item, index) => {
              ...
              return (
                <button
                  ...
                  className={`h-2.5 rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#155dfc] ${
                    isActive ? "w-6 bg-[#155dfc]" : "w-2.5 bg-gray-400/70 dark:bg-gray-500"
                  }`}
