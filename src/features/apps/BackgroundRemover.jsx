...
export const BackgroundRemover = () => {
  ...
  return (
    <article className="rounded-2xl border border-border/70 bg-card/45 p-5 backdrop-blur-xl">
      ...
      <label
        htmlFor="bg-upload"
        className="mt-4 flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-dashed border-border/70 bg-background/40 px-4 py-4 text-sm text-foreground/75 transition-colors hover:border-[#009689]/70"
      >
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <motion.button
          ...
          disabled={isLoading}
          className="inline-flex items-center gap-2 rounded-xl bg-[#009689] px-4 py-2.5 text-sm font-semibold text-white disabled:opacity-70"
        >
