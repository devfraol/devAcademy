  ...
  return (
    <article className="rounded-2xl border border-border/70 bg-card/45 p-5 backdrop-blur-xl">
      ...
      <label
        ...
        className="mt-4 flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-dashed border-border/70 bg-background/45 px-4 py-4 text-sm text-foreground/75 transition-colors hover:border-[#007a55]/70"
      >
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-[1fr_auto_1fr] sm:items-center">
        ...
        <ArrowLeftRight className="mx-auto h-4 w-4 text-[#007a55]" />
      ...
      <motion.button
        ...
        className="mt-4 inline-flex items-center gap-2 rounded-xl bg-[#007a55] px-4 py-2.5 text-sm font-semibold text-white"
      >
      ...
      {progress > 0 ? (
        <div className="mt-3 h-2 w-full rounded-full bg-background/70">
          <div className="h-2 rounded-full bg-[#007a55] transition-all" style={{ width: `${progress}%` }} />
        </div>
      ) : null}
    </article>
  );
