    ...
    >
      <div
        className={cn(
          ...
          isScrolled ? "border-primary/35 shadow-[0_16px_40px_rgba(0,122,85,0.15)]" : "border-border/70"
        )}
      >
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  "hover:scale-[1.03]",
                  active
                    ? "bg-primary text-primary-foreground shadow-[0_8px_20px_rgba(0,122,85,0.35)]"
